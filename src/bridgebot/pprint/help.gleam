pub fn to_string() -> String {
  "Given a plaintext representation of a hand (or many hands), a diagram will be
generated.  Hands are given as lists of suits, separated by a space. Honors can
be upper or lowercase. The character 'x' or 'X' can be provided instead of a
rank. Void suits can be represented using the '-' character or the strings
'void' or 'Void'.
...
You can also optionally provide a vulnerability, opening lead, and
